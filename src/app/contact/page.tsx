...
const Contact = () => (
    <div className="flex flex-col-reverse gap-6 md:flex items-center justify-center h-screen p-4 bg-blue text-white">
        <div className='max-w-prose flex flex-col m-4 gap-8 md:justify-center'>
            <h2 className="">Get in Touch!</h2>
            <p className="md:ml-6 lg:w-2/3">
            ...
            <Link href="mailto:connect@otublueprint.org?subject=Website%20Redirect:"
                ...
                <EmailIcon className="fill-white icon group-hover:fill-indigo-200"/>
                <p className="group-hover:text-indigo-200">otublueprint@hotmail.com</p>
            </Link>
            <div className="flex flex-row gap-8 md:ml-6">
                <Link href="https://www.instagram.com/otublueprint/">
                    <InstagramLogo className="fill-white icon hover:fill-indigo-200" />
                </Link>
                <Link href="https://discord.gg/yXATsYcFC8">
                    <DiscordLogo className="fill-white icon hover:fill-indigo-200" />
                </Link>
            </div>
        </div>
